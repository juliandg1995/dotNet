...
/*
    Ya que en todos estos casos la informacion inmutable, usamos
    String en vez de StringBuilder

    PERO,
    en los casos donde se requiera modificar el valor de un string en reiteradas ocasiones, conviene utilizar StringBuilder para ahorrar espacio en memoria
*/
